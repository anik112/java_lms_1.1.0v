...
public class BookSummaryService implements BookSummaryDao {
    ...
    public void saveWhenBookPurchase(BookSummary s) {
        try {
            if (s.getBookCode() != null) {
                ...
                PreparedStatement stmt = conn.prepareStatement("insert into lms_book_summary(book_id,book_name,total_stock,avilable_stock,already_lend,lost_qty) values(?,?,?,?,?,?)");
    ...
    public BookSummary getBookSummaryByBookCode(String bookCode) {
        ...
        try {
            ...
            PreparedStatement stmt = conn.prepareStatement("select * from lms_book_summary where book_id=?");
