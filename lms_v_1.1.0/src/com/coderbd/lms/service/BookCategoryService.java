...
public class BookCategoryService implements BookCategoryDao{
 Connection conn = DbConnection.getConnection();
    ...
    public List<BookCategory> getList() {
     ...
     public Set<BookCategory> getBookCategoryList() {
        Set<BookCategory> list = new HashSet<>();
        try {
            ...
            while (rs.next()) {
                ...
                bookCategory.setName(rs.getString(2));
                
                list.add(bookCategory);
            }
        } catch (SQLException ex) {
            Logger.getLogger(BookCategory.class.getName()).log(Level.SEVERE, null, ex);
        }
        return list;
    }
