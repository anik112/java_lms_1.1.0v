...
public class LmsStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        comboShiftId = new javax.swing.JComboBox<>();
        ...
        comboDptId.setEditable(true);

        comboShiftId.setEditable(true);
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(comboDistrict, 0, 259, Short.MAX_VALUE)
                                    ...
                                    .addComponent(comboShiftId, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                .addGap(42, 42, 42))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                .addComponent(btnAdd)
                                .addGap(18, 18, 18)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel18)
                            .addComponent(comboShiftId, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel4)
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        student=new Student(
                ...
                Integer.parseInt(comboDptId.getSelectedItem().toString()), 
                Integer.parseInt(comboShiftId.getSelectedItem().toString()), 
                txtHouseNo.getText(),
                txtRoadNo.getText(),
    ...
    public void showDptInComboBox(){
        
        DepartmentService departmentService=new DepartmentService();
        
        Set<Department> departments=departmentService.getDepartmentList();
        
        departments.forEach((d) ->{
            comboDptId.addItem(String.valueOf(d.getId()));
        });
        
    }
    
    
    public void showShiftInComboBox(){
        
        ShiftService shiftService=new ShiftService();
        
        Set<Shift> shifts=shiftService.getShiftList();
        
        shifts.forEach((s) -> {
            comboShiftId.addItem(String.valueOf(s.getId()));
            //System.out.println("From lms_student: "+s.getId());
        });
    ...
    private javax.swing.JComboBox<String> comboShiftId;
